...
class FilesController {
  /**
   * creating new file in DB and in disk
   *
   * returning the user based on the token:
   * If not found, return an error Unauthorized with a status code 401
   * craeting a file, you must specify:
   * name: as filename
   ...
   * retrive the new file with a status code 201
   */
  ...
  /**
   * must return the file document based on the ID
   *
   * returning he user based on the token:
   * If not found, return an error Unauthorized with a status code 401
  ...
  /**
   * returning all users file documents for a specific
   ...
   * Pagination:
   * for each single ge should be 20 items max
  ...
  /**
   * must set isPublic to true on the file document based on the ID
   *
   * returningthe user based on the token:
   * If not found, return an error Unauthorized with a status code 401
   * If no file document is linked to the user and the ID passed as parameter,
   * return an error Not found with a status code 404
   * Otherwise:
   * updating the value of isPublic to true
  ...
  /**
   * must set isPublic to false on the file document based on the ID
   *
   * Retrieve the user based on the token:
   * If not found, return an error Unauthorized with a status code 401
   * If no file document is linked to the user and the ID passed as parameter,
   * retrive an error Not found with a status code 404
   * Otherwise:
   * updating the value of isPublic to false
   * And return the file document with a status code 200
   */
  ...
  /**
   * retuning the content of the file document based on the ID
   *
   * no file document is linked to the ID passed as parameter, return an error
   ...
   * returning the content of the file with the correct MIME-type
   */
